...
def experiment(exp_name):
	...
	onehot_words,word_pos,sentence_lens_nchars,sentence_lens_nwords,vocabulary_size,max_char_len=read(file='train.h5', train=True)
	onehot_words_val, word_pos_val, sentence_lens_nchars_val, sentence_lens_nwords_val, _, _ =read(file='train.h5', train=False)
	...
	train_dict={'batch_size':52,'hidden_size':hidden_size,'decoder_dim':decoder_dim,
				'max_char_len'=max_char_len,'onehot_words'=onehot_words,'word_pos'=word_pos,'sentence_lens_nchars'=sentence_lens_nchars,
		'vocabulary_size'=vocabulary_size,'sentence_lens_nwords'=sentence_lens_nwords,
		'onehot_words' = onehot_words_val, 'word_pos' = word_pos_val, 'sentence_lens_nchars' = sentence_lens_nchars_val,
