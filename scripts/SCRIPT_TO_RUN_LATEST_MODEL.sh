...
def experiment(exp_name,logdir,prep_file_dir):
	from decoder import Decoder
        ...
        onehot_words,word_pos,sentence_lens_nchars,sentence_lens_nwords,vocabulary_size,max_char_len=read(file_name=prep_file_dir+'train.h5', train=True)
        onehot_words_val, word_pos_val, sentence_lens_nchars_val, sentence_lens_nwords_val, _, _ =read(file_name=prep_file_dir+'test.h5', train=False)
